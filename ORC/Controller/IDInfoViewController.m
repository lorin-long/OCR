...
@property (weak, nonatomic) IBOutlet UILabel *IDHero;
@property (weak, nonatomic) IBOutlet UILabel *IDAddress;
...
- (void)viewDidLoad {
    ...
    self.IDName.text=_IDInfo.name;
    self.IDHero.text=_IDInfo.nation;
    self.IDAddress.text=_IDInfo.address;
